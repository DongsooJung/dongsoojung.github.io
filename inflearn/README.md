...
인프런 비로그인 메인 페이지에 공개된 인기 강의 상위 100개를 매일 수집해
JSON과 Excel로 보관하고, 웹 대시보드에서 검색·필터링·다운로드할 수 있게
합니다.
...
`--limit` 옵션으로 수집량을 바꿀 수 있으며 기본값은 100입니다. 인프런이 한
페이지에 40개씩 제공하므로 기본 실행은 3페이지를 순차 수집합니다.
